...
#define KEYDEF(label, binding) insert_ ## label,
    #include "keybindings_insert.hh"
#undef KEYDEF
#define KEYDEF(label, binding) cmd_ ## label,
...
#undef KEYDEF
#define KEYDEF(label, binding) { binding, { command_id::insert_ ## label, NULL } },
    #include "keybindings_insert.hh"
};

static std::map<accelerator,keybinding> default_keybindings_cmd = {
#undef KEYDEF
#define KEYDEF(label, binding) { binding, { command_id::cmd_ ## label, NULL } },
    #include "keybindings_cmd.hh"
};
...
#undef KEYDEF
#define KEYDEF(label, binding) std::make_pair(#label, command_id::insert_ ## label),
    #include "keybindings_insert.hh"
};

static command_name_set command_names_cmd = {
#undef KEYDEF
#define KEYDEF(label, binding) std::make_pair(#label, command_id::cmd_ ## label),
    #include "keybindings_cmd.hh"
};
